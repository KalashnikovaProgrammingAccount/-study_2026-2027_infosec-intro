...
![Задание 5-6](image/3.png){#fig:003 width=80%}

![Задание 5-6](image/4.png){#fig:004 width=80%}
...
![Задание 7](image/5.png){#fig:005 width=80%}

![Задание 7](image/6.png){#fig:006 width=80%}

![Задание 7](image/7.png){#fig:007 width=80%}

8. Сравните полученную информацию с содержимым файла /etc/group: cat /etc/group

![Задание 8](image/8.png){#fig:008 width=80%}

9. От имени guest2 выполните регистрацию guest2 в группе guest: newgrp guest

![Задание 9](image/9.png){#fig:009 width=80%}
...
![Задание 10-11](image/10.png){#fig:010 width=80%}
